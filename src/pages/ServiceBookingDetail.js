...
const ServiceBookingDetail = () => {
    ...
    useEffect(() => {
        if (data) {
            const params = `?serviceid=${data?.data?.serviceid}`
                ...
                <section className="content-section">
                                ...
                                <form action className="user-desc">
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="userInputs">
                                                <label>Title</label>
                                                <input type="text" readOnly value={bookingDetail?.title || "N/A"} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-12">
                                            <div className="userInputs">
                                                ...
                                                <input type="text" readOnly value={bookingDetail?.categorys?.map((item) => item + " ") || "N/A"} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-12">
                                            <div className="userInputs">
                                                <label>Price</label>
                                                <input type="text" readOnly value={bookingDetail?.price || "N/A"} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-12">
                                            <div className="userInputs">
                                                ...
                                                <textarea name readOnly value={bookingDetail?.descriptions || "N/A"} />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <li>
                      ...
                      <span>6 years old</span>
                                        ...
                                        <li>
                                            <label>Date</label>
                                            <span>{bookingDetail?.bookingservicedate || "N/A"}</span>
                                        </li>
                                        <li>
                                            <label>Time</label>
                                            <span>{bookingDetail?.bookingservicetime || "N/A"}</span>
                                        </li>
                                ...
                                <div className="row">
                                    {
                                        bookingDetail?.servicesImages?.map((item, index) => (
