                  ...
                  <div className="row">
                    ...
                    <div className="col-12">
                      <div className="userInputs">
                        ...
                        <input type="text" readOnly value={bookingDetail?.numbersofpeople || "N/A"} />
                      </div>
                    </div>
                    ...
                    <div className="col-12">
                      <div className="userInputs">
                        <label>Rules</label>
                        <textarea name readOnly value={bookingDetail?.rules || "N/A"} />
                      </div>
                    </div>
                  </div>
                </form>
              ...
              <div className="col-12 col-lg-6 col-md-6">
                ...
                <div className="clientDetail">
                  <ul className="client_detail_lists">
                    ...
                    <li>
                      <label>Date</label>
                      <span>{bookingDetail?.booktabledate || "N/A"}</span>
                    </li>
                    <li>
                      <label>Time</label>
                      <span>{bookingDetail?.slottimetable || "N/A"}</span>
                    </li>
...
export default RestaurantBookingDetail